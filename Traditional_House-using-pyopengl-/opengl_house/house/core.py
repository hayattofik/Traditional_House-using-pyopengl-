...
from house.furniture import X, Bed, Tv, Armario, Fogao, Chairs,Fogao1,Gebeta,skinmedeb,Kidan,Wefcho,cloth,Stone
...
class Core:
    ...
    def __init__(self, **kwargs):
        ...
        # set perspective
        gluPerspective(60, (display[1] / display[1]), .5, 60.0)
        ...
        self.furnitures = [
         # X(self.texture_loader),
            ...
            Fogao(self.texture_loader,30, 0, -90, init_rotate_y=1, init_angle_rotate=90),
            Wefcho(self.texture_loader, 30, 0, -90, init_rotate_y=1, init_angle_rotate=90),
           Fogao1(self.texture_loader, 30, 0, -90, init_rotate_y=1, init_angle_rotate=90),
          Gebeta(self.texture_loader, 5, 2, -20, init_rotate_y=1, init_angle_rotate=180),
           skinmedeb(self.texture_loader, 5, 2, -20, init_rotate_y=1, init_angle_rotate=180),
            Kidan(self.texture_loader, 5, 2, -20, init_rotate_y=1, init_angle_rotate=180),
            cloth(self.texture_loader, 5, 2, -20, init_rotate_y=1, init_angle_rotate=180),
            Stone(self.texture_loader),
             Chairs(self.texture_loader, 15, 0, -30, init_rotate_y=1, init_angle_rotate=90),  # cadeira no quarto
             Chairs(self.texture_loader, -50, 0, 5, init_rotate_y=1, init_angle_rotate=180),  # no cozinha virada pro quarto
             Chairs(self.texture_loader, -40, 0, 5, init_rotate_y=1, init_angle_rotate=180),  # no cozinha virada pro quarto
            Chairs(self.texture_loader, -30, 0, 5, init_rotate_y=1, init_angle_rotate=180),  # no cozinha virada pro quarto
            Chairs(self.texture_loader, 10, 0, -88) ] # no cozinha virada pro foão e o armário
        # ]
