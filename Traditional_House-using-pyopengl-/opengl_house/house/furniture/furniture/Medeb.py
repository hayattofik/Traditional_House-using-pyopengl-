...
def draw_cube(texture,translate=None, scale=None, color=None):
    if color is None:
        color = default_color
...
def draw_mattress_base(texture):
    draw_cube(texture,translate=(-4, 3, -3), scale=(-2, -4, 12.5))
...
class Bed(BaseFurniture):
    ...
    def __init__(self, texture_loader: TextureLoader):
        ...
        self.texture = texture_loader.load_texture('white.jpg')
    ...
    def draw_on_scene(self):
        ...
        draw_mattress_base(self.texture)