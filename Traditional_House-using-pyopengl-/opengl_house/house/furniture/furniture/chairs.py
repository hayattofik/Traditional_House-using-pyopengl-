...
#used to draw the cube for the chair
...
class Chairs(BaseFurniture):
    ...
    def __init__(self, texture_loader: TextureLoader, init_x=0.0, init_y=0.0, init_z=0.0, init_rotate_x=0.0, init_rotate_y=0.0,
        ...
        self.chair_texture = [None]
        self.chair_texture[0] = self.texture_loader.load_texture('hide.jpg')
    ...
    def desenhar_cadeira(self):
        ...
        glScalef(3, 0.4, 3)
        Cubo(self.wireframe, texture=self.chair_texture[0])
        glPopMatrix()
